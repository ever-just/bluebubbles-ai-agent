...
```
docs/
├── CHANGELOG.md       # Project release notes and milestones
├── guides/            # How-tos, setup checklists, project structure references
├── notes/             # Research plans and exploratory documents
├── operations/        # Runbooks and deployment guides
├── templates/         # Status/update templates for recurring comms
├── logs/              # Optional log captures (gitignored by default)
